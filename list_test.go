...
func checkListLen[E any](t *testing.T, l *List[E], len int) bool {
	if n := l.Len(); n != len {
...
func checkListPointers[E any](t *testing.T, l *List[E], es []*Element[E]) {
	root := &l.root
...
func checkList(t *testing.T, l *List[any], es []any) {
	if !checkListLen(t, l, len(es)) {
		return
	}
...
func TestMove(t *testing.T) {
	...
	l.MoveBefore(e2, e4)
	checkListPointers(t, l, []*Element[any]{e1, e3, e2, e4})
	e2, e3 = e3, e2

	l.MoveBefore(e4, e1)
	checkListPointers(t, l, []*Element[any]{e4, e1, e2, e3})
